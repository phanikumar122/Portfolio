...
import { ArrowRight, Layout, Cpu, Layers } from "lucide-react";
  ...
  const pillars = [
    {
      ...
      bg: "bg-[rgba(37,99,235,0.03)]",
      border: "border-[rgba(37,99,235,0.1)]",
    },
    {
    ...
    },
    {
      ...
      border: "border-[rgba(100,116,139,0.1)]",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-6">
              <ScrollReveal>
                ...
                <a
                  href="#projects"
                  className="group inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-bold uppercase tracking-widest text-[11px] sm:text-xs transition-all duration-300"
                  style={{
                    background: "var(--color-primary)",
                    color: "#FFFFFF",
                    boxShadow: "0 4px 14px var(--color-glow-strong)",
                  }}
                  onMouseEnter={(e) => {
            ...
            <div className="lg:col-span-6 flex flex-col gap-4">
              {pillars.map((pillar, idx) => (
                <motion.div
                  ...
                  className={`p-5 rounded-2xl border ${pillar.border} ${pillar.bg} shadow-xs hover:shadow-[var(--shadow-md)] hover:-translate-y-1 transition-all duration-300`}
                >
                  <div className="flex items-center gap-3.5 mb-2.5">
                    <div className="w-8 h-8 rounded-xl bg-white border border-[var(--color-border)] flex items-center justify-center shadow-xs">
                      {pillar.icon}
                    </div>
